...
const DatesSection = () => {
  ...
  return (
    <section id="dates" className="py-20 bg-icosom-dark text-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Important Dates</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-icosom-300 to-icosom-teal mx-auto mb-6"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {importantDates.map((item, index) => (
            <Card key={index} className="bg-icosom-800/50 border-none overflow-hidden">

  ...
  const speakers = [
    {
      ...
      initials: "AS",
      profileLink:
        "https://scholar.google.com/citations?user=-UZ82kEAAAAJ&hl=en",
    },
    {
      ...
      initials: "HT",
      profileLink:
        "https://scholar.google.co.in/citations?user=967CPlsAAAAJ&hl=en",
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="lg:max-w-4xl mx-auto grid place-items-center grid-cols-1 md:grid-cols-2 gap-16">
          {speakers.map((speaker, index) => (
            <div
              key={index}
              className="text-center p-4 w-full bg-slate-50 rounded-lg shadow hover:shadow-md cursor-pointer"
            >
